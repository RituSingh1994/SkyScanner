package com.skyscanner.keyword;
...
import com.skyscanner.constant.Constant;
import com.skyscanner.customutil.CustomUtil;
...
public static Logger log = Logger.getLogger(Keyword.class);
	...
	public static void failedTCScreenshot(String tcName) {
		...
		try {
			FileUtils.copyFile(source, new File("C:\\Users\\Lenovo\\eclipse-workspace\\SkyScanner\\Screenshots\\" + tcName
					+ " dated " + datetime + ".png"));
		} catch (IOException e) {
